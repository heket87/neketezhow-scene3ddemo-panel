...
var OpenFeature = (() => {
  ...
  var FirstMatchStrategy2 = class extends FirstMatchStrategy {
    constructor() {
      super(ClientProviderStatus);
    }
  };
  var FirstSuccessfulStrategy2 = class extends FirstSuccessfulStrategy {
    constructor() {
      super(ClientProviderStatus);
    }
  };
  var ComparisonStrategy2 = class extends ComparisonStrategy {
    constructor(fallbackProvider, onMismatch) {
      super(ClientProviderStatus, fallbackProvider, onMismatch);
    }
  };
  ...
  var MultiProvider = class _MultiProvider {
    constructor(constructorProviders, evaluationStrategy = new FirstMatchStrategy2(), logger = new DefaultLogger()) {
      ...
      this.statusTracker = new StatusTracker(this.events, ClientProviderStatus, ClientProviderEvents);

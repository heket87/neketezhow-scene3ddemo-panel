...
var FirstMatchStrategy = class extends import_core6.BaseFirstMatchStrategy {
  constructor() {
    super(import_core.ClientProviderStatus);
  }
};
var FirstSuccessfulStrategy = class extends import_core6.BaseFirstSuccessfulStrategy {
  constructor() {
    super(import_core.ClientProviderStatus);
  }
};
var ComparisonStrategy = class extends import_core6.BaseComparisonStrategy {
  constructor(fallbackProvider, onMismatch) {
    super(import_core.ClientProviderStatus, fallbackProvider, onMismatch);
  }
};
...
var MultiProvider = class _MultiProvider {
  constructor(constructorProviders, evaluationStrategy = new FirstMatchStrategy(), logger = new import_core7.DefaultLogger()) {
    ...
    this.statusTracker = new import_core7.StatusTracker(this.events, import_core.ClientProviderStatus, import_core3.ClientProviderEvents);
  ...
  flagResolutionProxy(flagKey, flagType, defaultValue, context) {
    ...
    const resolutions = results.filter(
      (r) => Boolean(r)
    );
...
var OpenFeatureClient = class {
  ...
  addHandler(eventType, handler, options) {
    ...
    const shouldRunNow = (0, import_core8.statusMatchesEvent)(eventType, this.providerStatus);
    if (shouldRunNow) {
      try {
        handler({
...
var OpenFeatureAPI = class _OpenFeatureAPI extends import_core9.OpenFeatureCommonAPI {
  ...
  setProviderAndWait(clientOrProvider, providerContextOrUndefined, contextOrUndefined) {
    return __async(this, null, function* () {
      ...
      const provider = domain ? (0, import_core9.objectOrUndefined)(providerContextOrUndefined) : (0, import_core9.objectOrUndefined)(clientOrProvider);
      const context = domain ? (0, import_core9.objectOrUndefined)(contextOrUndefined) : (0, import_core9.objectOrUndefined)(providerContextOrUndefined);
      if (context) {
        if (domain) {
  ...
  setProvider(domainOrProvider, providerContextOrUndefined, contextOrUndefined) {
    ...
    const provider = domain ? (0, import_core9.objectOrUndefined)(providerContextOrUndefined) : (0, import_core9.objectOrUndefined)(domainOrProvider);
    const context = domain ? (0, import_core9.objectOrUndefined)(contextOrUndefined) : (0, import_core9.objectOrUndefined)(providerContextOrUndefined);
    if (context) {
      if (domain) {
        this._domainScopedContext.set(domain, context);
  ...
  setContext(domainOrContext, contextOrUndefined) {
    return __async(this, null, function* () {
      ...
      const context = (_b = (_a = (0, import_core9.objectOrUndefined)(domainOrContext)) != null ? _a : (0, import_core9.objectOrUndefined)(contextOrUndefined)) != null ? _b : {};
      if (domain) {
  ...
  getContext(domainOrUndefined) {
    const domain = (0, import_core9.stringOrUndefined)(domainOrUndefined);
    if (domain) {

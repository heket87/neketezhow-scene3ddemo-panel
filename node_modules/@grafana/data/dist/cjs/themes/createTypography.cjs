...
"use strict";
const ThemeTypographyInputSchema = z.z.object({
  fontFamily: z.z.string().optional(),
  fontFamilyMonospace: z.z.string().optional(),
  fontSize: z.z.number().positive().optional(),
  fontWeightLight: z.z.number().positive().optional(),
  fontWeightRegular: z.z.number().positive().optional(),
  fontWeightMedium: z.z.number().positive().optional(),
  fontWeightBold: z.z.number().positive().optional(),
  // what's the font-size on the html element.
  // 16px is the default font-size used by browsers.
  htmlFontSize: z.z.number().positive().optional()
});
...
exports.ThemeTypographyInputSchema = ThemeTypographyInputSchema;

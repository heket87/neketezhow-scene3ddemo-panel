...
const onBackground = (foreground, background) => {
  const fg = tinycolor__default.default(foreground).toRgb();
  const bg = tinycolor__default.default(background).toRgb();
...
exports.asRgbString = asRgbString;
...
exports.onBackground = onBackground;

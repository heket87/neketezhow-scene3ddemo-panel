...
"use strict";
const ThemeSpacingOptionsSchema = z.z.object({
  gridSize: z.z.int().positive().optional()
});
...
exports.ThemeSpacingOptionsSchema = ThemeSpacingOptionsSchema;
exports.createSpacing = createSpacing;
//# sourceMappingURL=createSpacing.cjs.map

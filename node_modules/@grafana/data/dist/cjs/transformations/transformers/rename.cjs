...
const renameFieldsTransformer = {
  id: ids.DataTransformerID.rename,
...
const createRenamer = (renameByName) => (frame) => {
  ...
  return frame.fields.map((field) => {
    const displayName = fieldState.getFieldDisplayName(field, frame);
...
exports.renameFieldsTransformer = renameFieldsTransformer;
//# sourceMappingURL=rename.cjs.map

...
"use strict";
var ConcatenateFrameNameMode = /* @__PURE__ */ ((ConcatenateFrameNameMode2) => {
  ConcatenateFrameNameMode2["Drop"] = "drop";
  ConcatenateFrameNameMode2["FieldName"] = "field";
  ConcatenateFrameNameMode2["Label"] = "label";
  return ConcatenateFrameNameMode2;
})(ConcatenateFrameNameMode || {});
const concatenateTransformer = {
  id: ids.DataTransformerID.concatenate,
...
function concatenateFields(data, opts) {
  ...
  for (const frame of data) {
    ...
    for (const f of frame.fields) {
      ...
      copy.state = void 0;
      if (frame.name) {
        if (opts.frameNameMode === "drop" /* Drop */) {
        } else if (opts.frameNameMode === "label" /* Label */) {
          copy.labels = { ...f.labels };
          copy.labels[frameNameLabel] = frame.name;
        } else if (!copy.name || copy.name === dataFrame.TIME_SERIES_VALUE_FIELD_NAME) {
...
exports.ConcatenateFrameNameMode = ConcatenateFrameNameMode;
exports.concatenateFields = concatenateFields;
exports.concatenateTransformer = concatenateTransformer;

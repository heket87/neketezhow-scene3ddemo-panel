...
"use strict";
var LabelsToFieldsMode = /* @__PURE__ */ ((LabelsToFieldsMode2) => {
  LabelsToFieldsMode2["Columns"] = "columns";
  LabelsToFieldsMode2["Rows"] = "rows";
  return LabelsToFieldsMode2;
})(LabelsToFieldsMode || {});
const labelsToFieldsTransformer = {
  id: ids.DataTransformerID.labelsToFields,
    ...
    for (const field of frame.fields) {
      if (field.labels) {
        ...
        if (vals.length) {
          result.push({
            ...frame,
            name: fieldState.getFieldDisplayName(field, frame, data),
            fields: [
              { name: "label", type: dataFrame.FieldType.string, config: {}, values: keys },
              { name: "value", type: dataFrame.FieldType.string, config: {}, values: vals }
            ],
            length: vals.length
          });
        }
...
exports.LabelsToFieldsMode = LabelsToFieldsMode;
exports.labelsToFieldsTransformer = labelsToFieldsTransformer;
//# sourceMappingURL=labelsToFields.cjs.map

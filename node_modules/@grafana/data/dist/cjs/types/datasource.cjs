...
var makeClassES5Compatible = require('../utils/makeClassES5Compatible.cjs');
var throwIfAngular = require('../utils/throwIfAngular.cjs');
var plugin = require('./plugin.cjs');

"use strict";
class DataSourcePlugin extends plugin.GrafanaPlugin {
  ...
  setConfigCtrl(ConfigCtrl) {
    deprecationWarning.deprecationWarning("DataSourcePlugin", "setConfigCtrl");
    this.angularConfigCtrl = ConfigCtrl;
    return this;
  }
  /** @deprecated it will be removed in a future release */
  setQueryCtrl(QueryCtrl) {
    deprecationWarning.deprecationWarning("DataSourcePlugin", "setQueryCtrl");
  ...
  setComponentsFromLegacyExports(pluginExports) {
    throwIfAngular.throwIfAngular(pluginExports);
...
LanguageProvider = makeClassES5Compatible.makeClassES5Compatible(LanguageProvider);
DataSourceApi = makeClassES5Compatible.makeClassES5Compatible(DataSourceApi);

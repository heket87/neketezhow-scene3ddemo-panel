...
var getPanelDataSummary = require('../panel/suggestions/getPanelDataSummary.cjs');
...
class VisualizationSuggestionsBuilder {
  constructor(dataFrames) {
    this.list = [];
    this.dataSummary = getPanelDataSummary.getPanelDataSummary(dataFrames);
  }
  getList() {
    return this.list;
  }
  getListAppender(suggestionDefaults) {
    const withDefaults = (suggestion) => {
      const s = lodash.defaultsDeep({}, suggestion, suggestionDefaults);
      return {
        ...s,
...
exports.getSuggestionHash = getSuggestionHash;

...
var FunctionalVector = require('./FunctionalVector.cjs');

"use strict";
class CircularVector extends FunctionalVector.FunctionalVector {
  constructor(options) {
    super();
...
//# sourceMappingURL=CircularVector.cjs.map

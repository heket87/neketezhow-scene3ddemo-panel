...
var UnaryOperationID = /* @__PURE__ */ ((UnaryOperationID2) => {
  ...
  UnaryOperationID2["Percent"] = "percent";
  return UnaryOperationID2;
})(UnaryOperationID || {});
const unaryOperators = new Registry.Registry(() => {
  return [
    {
      id: "abs" /* Abs */,
      name: "Absolute value",
    ...
    },
    {
      id: "percent" /* Percent */,
      name: "Percentage",
      operation: (value, total = 1) => value / (total || 1),
      unaryOperationID: "percent" /* Percent */
    }
  ];
});
...
//# sourceMappingURL=unaryOperators.cjs.map

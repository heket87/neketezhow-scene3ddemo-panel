...
export declare const hasLogsContextSupport: (datasource: unknown) => datasource is DataSourceWithLogsContextSupport;
export declare const hasLogsLabelTypesSupport: (datasource: unknown) => datasource is DataSourceWithLogsLabelTypesSupport;
/**
...
export declare const hasSupplementaryQuerySupport: <TQuery extends DataQuery>(datasource: DataSourceApi | (DataSourceApi & DataSourceWithSupplementaryQueriesSupport<TQuery>), type: SupplementaryQueryType, dsRequest?: DataQueryRequest<DataQuery>) => datasource is DataSourceApi & DataSourceWithSupplementaryQueriesSupport<TQuery>;
export declare const hasLogsContextUiSupport: (datasource: unknown) => datasource is DataSourceWithLogsContextSupport;
...
export declare class LogSortOrderChangeEvent extends BusEventWithPayload<LogSortOrderChangePayload> {
    static type: string;
}

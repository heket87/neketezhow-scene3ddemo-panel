...
declare abstract class DataSourceApi<TQuery extends DataQuery = DataQuery, TOptions extends DataSourceJsonData = DataSourceJsonData, TQueryImportConfiguration extends Record<string, object> = {}> {
     ...
     */
    getDrilldownsApplicability?(options?: DataSourceGetDrilldownsApplicabilityOptions<TQuery>): Promise<DrilldownsApplicability[]>;
    /**
     * Get recommended drilldowns for a dashboard
     */
    getRecommendedDrilldowns?(options?: DataSourceGetRecommendedDrilldownsOptions<TQuery>): Promise<DrilldownRecommendation>;
    /**
 ...
 */
export interface DataSourceGetTagKeysOptions<TQuery extends DataQuery = DataQuery> extends DataSourceFilteringRequestOptions<TQuery> {
    /**
 ...
 */
export interface DataSourceGetTagValuesOptions<TQuery extends DataQuery = DataQuery> extends DataSourceFilteringRequestOptions<TQuery> {
    key: string;
    /**
     * The other existing filters or base filters. New in v10.3
     */
...
export interface DataSourceGetDrilldownsApplicabilityOptions<TQuery extends DataQuery = DataQuery> extends DataSourceFilteringRequestOptions<TQuery> {
    filters?: AdHocVariableFilter[];
    groupByKeys?: string[];
}
export interface DataSourceGetRecommendedDrilldownsOptions<TQuery extends DataQuery = DataQuery> extends DataSourceFilteringRequestOptions<TQuery> {
    dashboardUid?: string;
    filters?: AdHocVariableFilter[];
    groupByKeys?: string[];
}

...
export type PluginAddedLinksConfigureFunc<Context extends object> = (context: Readonly<Context> | undefined) => Partial<{
    title: string;
    description: string;
    path: string;
...
export declare enum PluginExtensionPointPatterns {
...
export declare enum PluginExtensionExposedComponents {
...
export type PluginExtensionDataSourceConfigContext<JsonData extends DataSourceJsonData = DataSourceJsonData, SecureJsonData = {}> = {

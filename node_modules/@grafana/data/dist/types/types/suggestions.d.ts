 ...
 */
export declare function getSuggestionHash(suggestion: Omit<PanelPluginVisualizationSuggestion, 'hash'>): string;
/**
 * @alpha
 ...
 */
export interface PanelPluginVisualizationSuggestion<TOptions extends unknown = {}, TFieldConfig extends {} = {}> extends VisualizationSuggestion<TOptions, TFieldConfig> {
    /** Name of suggestion */
    name: string;
    /** Panel plugin id */
    pluginId: string;
 ...
 */
export type VisualizationSuggestionsSupplier<TOptions extends unknown, TFieldConfig extends {} = {}> = (panelDataSummary: PanelDataSummary) => Array<VisualizationSuggestion<TOptions, TFieldConfig>> | void;
/**
...
export declare class VisualizationSuggestionsBuilder {
    ...
    list: PanelPluginVisualizationSuggestion[];
    ...
    getListAppender(suggestionDefaults: Omit<PanelPluginVisualizationSuggestion, 'hash'>): {
        append: (suggestion: VisualizationSuggestion) => void;
    };
}

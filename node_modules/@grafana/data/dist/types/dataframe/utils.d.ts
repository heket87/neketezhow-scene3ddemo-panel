 ...
 */
export declare function alignTimeRangeCompareData(series: DataFrame, diff: number, theme: GrafanaTheme2): void;
/**
 ...
 */
export declare function shouldAlignTimeCompare(compareFrame: DataFrame, allFrames: DataFrame[], timeRange: TimeRange): boolean;

export declare const standardTransformers: {
    ...
    renameByRegexTransformer: import("..").DataTransformerInfo<import("..").RenameByRegexTransformerOptions>;
    histogramTransformer: import("..").SynchronousDataTransformerInfo<import("..").HistogramTransformerInputs>;
    ...
    convertFrameTypeTransformer: import("..").DataTransformerInfo<import("./transformers/convertFrameType").ConvertFrameTypeTransformerOptions>;
    groupingToMatrixTransformer: import("..").DataTransformerInfo<import("..").GroupingToMatrixTransformerOptions>;
    ...
    transposeTransformer: import("..").DataTransformerInfo<import("./transformers/transpose").TransposeTransformerOptions>;
};

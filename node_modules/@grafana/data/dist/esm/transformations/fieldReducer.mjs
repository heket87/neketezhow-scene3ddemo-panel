...
function getFieldTypeForReducer(id, fallback) {
  return id === "count" /* count */ || id === "distinctCount" /* distinctCount */ || id === "changeCount" /* changeCount */ || id === "countAll" /* countAll */ ? FieldType.number : id === "allIsNull" /* allIsNull */ || id === "allIsZero" /* allIsZero */ ? FieldType.boolean : fallback;
}

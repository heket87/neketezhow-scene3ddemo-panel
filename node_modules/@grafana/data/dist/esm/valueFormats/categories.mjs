...
const getCategories = () => [
  ...
  },
  {
    ...
    formats: [
      {
        name: t("grafana-data.valueFormats.categories.acceleration.formats.name-meters-sec", "Meters/sec\xB2"),
        id: "accMS2",
        fn: toFixedUnit("m/sec\xB2")
      },
      {
        name: t("grafana-data.valueFormats.categories.acceleration.formats.name-feet-sec", "Feet/sec\xB2"),
        id: "accFS2",
        fn: toFixedUnit("f/sec\xB2")
      },
      {
  ...
  },
  {
    ...
    formats: [
      {
        name: t("grafana-data.valueFormats.categories.angle.formats.name-degrees", "Degrees (\xB0)"),
        id: "degree",
        fn: toFixedUnit("\xB0")
      },
      {
  ...
  },
  {
    ...
    formats: [
      {
        name: t("grafana-data.valueFormats.categories.area.formats.name-square-meters", "Square Meters (m\xB2)"),
        id: "areaM2",
        fn: toFixedUnit("m\xB2")
      },
      {
        name: t("grafana-data.valueFormats.categories.area.formats.name-square-feet", "Square Feet (ft\xB2)"),
        id: "areaF2",
        fn: toFixedUnit("ft\xB2")
      },
      {
        name: t("grafana-data.valueFormats.categories.area.formats.name-square-miles", "Square Miles (mi\xB2)"),
        id: "areaMI2",
        fn: toFixedUnit("mi\xB2")
      },
      {
    ...
    formats: [
      ...
      },
      {
        name: t(
          ...
          "nanogram per cubic meter (ng/m\xB3)"
        ),
        id: "conngm3",
      ...
      },
      {
        name: t(
          ...
          "nanogram per normal cubic meter (ng/Nm\xB3)"
        ),
        id: "conngNm3",
      ...
      },
      {
        name: t(
          ...
          "microgram per cubic meter (\u03BCg/m\xB3)"
        ),
        id: "con\u03BCgm3",
      ...
      },
      {
        name: t(
          ...
          "microgram per normal cubic meter (\u03BCg/Nm\xB3)"
        ),
        id: "con\u03BCgNm3",
      ...
      },
      {
        name: t(
          ...
          "milligram per cubic meter (mg/m\xB3)"
        ),
        id: "conmgm3",
      ...
      },
      {
        name: t(
          ...
          "milligram per normal cubic meter (mg/Nm\xB3)"
        ),
        id: "conmgNm3",
        fn: toFixedUnit("mg/Nm\xB3")
      },
      {
        name: t("grafana-data.valueFormats.categories.concentration.formats.name-g-m3", "gram per cubic meter (g/m\xB3)"),
        id: "congm3",
      ...
      },
      {
        name: t(
          ...
          "gram per normal cubic meter (g/Nm\xB3)"
        ),
        id: "congNm3",
  ...
  },
  {
    ...
    formats: [
      ...
      {
        name: t("grafana-data.valueFormats.categories.currency.formats.name-gbp", "Pounds (\xA3)"),
        id: "currencyGBP",
        fn: currency("\xA3")
      },
      {
      ...
      {
        name: t("grafana-data.valueFormats.categories.currency.formats.name-jpy", "Yen (\xA5)"),
        id: "currencyJPY",
        fn: currency("\xA5")
      },
      {
      ...
      {
        name: t("grafana-data.valueFormats.categories.currency.formats.name-isk", "Icelandic Kr\xF3na (kr)"),
        id: "currencyISK",
        fn: currency("kr", true)
      },
      {
      ...
      {
        name: t("grafana-data.valueFormats.categories.currency.formats.name-pyg", "Guaran\xED (\u20B2)"),
        id: "currencyPYG",
        fn: currency("\u20B2")
      },
      {
  ...
  },
  {
    ...
    formats: [
      ...
      {
        name: t("grafana-data.valueFormats.categories.energy.formats.name-microfarad", "Microfarad (\xB5F)"),
        id: "\xB5farad",
        fn: SIPrefix("F", -2)
      },
      {
      ...
      {
        name: t("grafana-data.valueFormats.categories.energy.formats.name-microhenry", "Microhenry (\xB5H)"),
        id: "\xB5henry",
        fn: SIPrefix("H", -2)
      },
      {
  ...
  },
  {
    ...
    formats: [
      ...
      {
        name: t("grafana-data.valueFormats.categories.radiation.formats.name-microsievert", "microSievert (\xB5Sv)"),
        id: "radusv",
        fn: SIPrefix("Sv", -2)
      },
      {
  ...
  },
  {
    ...
    formats: [
      {
        name: t("grafana-data.valueFormats.categories.temperature.formats.name-celsius", "Celsius (\xB0C)"),
        id: "celsius",
        fn: toFixedUnit("\xB0C")
      },
      {
        name: t("grafana-data.valueFormats.categories.temperature.formats.name-fahrenheit", "Fahrenheit (\xB0F)"),
        id: "fahrenheit",
        fn: toFixedUnit("\xB0F")
      },
      {
  ...
  },
  {
    ...
    formats: [
      ...
      {
        name: t("grafana-data.valueFormats.categories.time.formats.name-microseconds", "microseconds (\xB5s)"),
        id: "\xB5s",
        fn: toMicroSeconds
      },
      {

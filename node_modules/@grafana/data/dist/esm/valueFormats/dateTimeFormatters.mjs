...
import { toUtc, toDuration as toDuration$1, dateTime } from '../datetime/moment_wrapper.mjs';
...
var Interval = /* @__PURE__ */ ((Interval2) => {
  ...
  Interval2["Millisecond"] = "millisecond";
  return Interval2;
})(Interval || {});
const UNITS = [
  "year" /* Year */,

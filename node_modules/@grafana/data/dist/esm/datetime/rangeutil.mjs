import { t, formatDateRange } from '@grafana/i18n';
import { getFeatureToggle } from '../utils/featureToggles.mjs';
import { parse, isMathString } from './datemath.mjs';
import { dateTimeFormat, toIANATimezone, dateTimeFormatTimeAgo, timeZoneAbbrevation } from './formatter.mjs';
...
function describeTimeRange(range, timeZone, quickRanges) {
  ...
  if (isDateTime(range.from) && isDateTime(range.to)) {
    ...
    const intlFormatOptions = {
      ...intlFormat,
      timeZone: timeZone ? toIANATimezone(timeZone) : void 0
    };

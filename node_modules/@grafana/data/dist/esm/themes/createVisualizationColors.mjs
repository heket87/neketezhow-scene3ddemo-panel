...
"use strict";
const createShadeSchema = (color) => z.enum([`super-light-${color}`, `light-${color}`, color, `semi-dark-${color}`, `dark-${color}`]);
const createHueSchema = (color) => z.object({
...
const ThemeVisualizationColorsInputSchema = z.object({
...
export { ThemeVisualizationColorsInputSchema, createVisualizationColors };

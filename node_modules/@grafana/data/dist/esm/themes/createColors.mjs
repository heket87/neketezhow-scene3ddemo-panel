...
import { z } from 'zod';
import { getContrastRatio, darken, lighten, alpha, emphasize } from './colorManipulator.mjs';
import { palette } from './palette.mjs';
import { ThemeRichColorInputSchema } from './types.mjs';

"use strict";
const ThemeColorsModeSchema = z.enum(["light", "dark"]);
const createThemeColorsBaseSchema = (color) => z.object({
...
const ThemeColorsInputSchema = createThemeColorsBaseSchema(ThemeRichColorInputSchema);
class DarkColors {
  constructor() {
    this.mode = "dark";
...
export { ThemeColorsInputSchema, createColors };
//# sourceMappingURL=createColors.mjs.map

import { cloneDeep, defaultsDeep, isNumber, unset, get, set } from 'lodash';
...
import { guessFieldTypeForField, createDataFrame } from '../dataframe/processDataFrame.mjs';
      ...
      if (field.type === FieldType.frame) {
        field.values = applyFieldOverrides({
          ...
          data: field.values.map((nestedFrame) => {
            const result = nestedFrame != null ? nestedFrame : createDataFrame({ fields: [] });
...
const DataLinksContext = createContext({ dataLinkPostProcessor: defaultInternalLinkPostProcessor });
const useDataLinksContext = () => useContext(DataLinksContext);

export { DataLinksContext, applyFieldOverrides, applyRawFieldOverrides, findNumericFieldMinMax, getFieldDataContextClone, getLinksSupplier, setDynamicConfigValue, setFieldConfigDefaults, useDataLinksContext, useFieldOverrides, validateFieldConfig };

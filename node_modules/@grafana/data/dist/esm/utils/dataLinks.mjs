...
function mapInternalLinkToExplore(options) {
  ...
  if (query && typeof query === "object" && !((_b = query.datasource) == null ? void 0 : _b.uid) && internalLink.datasourceUid) {
  ...
  const interpolatedPanelsState = interpolateObject((_c = link.internal) == null ? void 0 : _c.panelsState, scopedVars, replaceVariables);
  const interpolatedCorrelationData = interpolateObject((_d = link.meta) == null ? void 0 : _d.correlationData, scopedVars, replaceVariables);

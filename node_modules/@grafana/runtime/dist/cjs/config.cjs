...
class GrafanaBootConfig {
  constructor(options) {
    ...
    this.windowTitlePrefix = "Grafana - ";
    this.buildInfo = {
      version: "1.0",
      commit: "1",
      env: "production"
    ...
    this.externalUserUpgradeLinkUrl = "";
    ...
    this.awsPerDatasourceHTTPProxyEnabled = false;
    this.azure = {
    ...
    this.unifiedAlerting = {
      ...
      stateHistory: {
        backend: void 0,
        primary: void 0,
        prometheusTargetDatasourceUID: void 0,
        prometheusMetricName: void 0
      },
    ...
    this.listScopesEndpoint = "";
    this.openFeatureContext = {};
...
const config = new GrafanaBootConfig({
  ...bootData.settings,

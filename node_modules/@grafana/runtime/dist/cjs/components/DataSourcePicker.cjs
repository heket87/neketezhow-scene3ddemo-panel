...
var DataSourceWithBackend = require('../utils/DataSourceWithBackend.cjs');

"use strict";
class DataSourcePicker extends React.PureComponent {
  constructor(props) {
    super(props);
    this.dataSourceSrv = dataSourceSrv.getDataSourceSrv();
    this.state = {};
  ...
  getCurrentValue() {
    ...
    if (uid === DataSourceWithBackend.ExpressionDatasourceRef.uid || uid === DataSourceWithBackend.ExpressionDatasourceRef.name) {
...
//# sourceMappingURL=DataSourcePicker.cjs.map

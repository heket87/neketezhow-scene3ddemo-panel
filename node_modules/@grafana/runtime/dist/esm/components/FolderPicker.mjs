...
function FolderPicker(props) {
  if (FolderPickerComponent) {
    return /* @__PURE__ */ jsx(FolderPickerComponent, { ...props });
  }
  if (process.env.NODE_ENV !== "production") {
    return /* @__PURE__ */ jsx("div", { children: "@grafana/runtime FolderPicker is not set" });
  }
  return null;
}

export { FolderPicker, setFolderPicker };

...
import { DataSourceApi, getDataSourceRef, parseLiveChannelAddress, dataFrameToJSON, StreamingFrameAction, makeClassES5Compatible } from '@grafana/data';
...
import { isQueryServiceCompatible } from './qscheck.mjs';

...
export declare enum LogsEditorMode {
    Builder = "builder",
    Raw = "raw"
}
export declare enum BuilderQueryEditorExpressionType {
    And = "and",
...
export declare enum BuilderQueryEditorPropertyType {
    Boolean = "boolean",
    Datetime = "datetime",
    Function = "function",
    Interval = "interval",
...
export declare enum BuilderQueryEditorOrderByOptions {
    Asc = "asc",
    Desc = "desc"
}
export declare enum BuilderQueryEditorReduceParameterTypes {
    Generic = "generic",
    Numeric = "numeric"
}
...
export declare const defaultBuilderQueryEditorColumnsExpression: Partial<BuilderQueryEditorColumnsExpression>;
...
export declare const defaultBuilderQueryEditorWhereExpression: Partial<BuilderQueryEditorWhereExpression>;
export interface BuilderQueryEditorWhereExpressionArray {
    expressions: Array<BuilderQueryEditorWhereExpression>;
    type: BuilderQueryEditorExpressionType;
}
export declare const defaultBuilderQueryEditorWhereExpressionArray: Partial<BuilderQueryEditorWhereExpressionArray>;
...
export declare const defaultBuilderQueryEditorReduceExpression: Partial<BuilderQueryEditorReduceExpression>;
export interface BuilderQueryEditorReduceExpressionArray {
    expressions: Array<BuilderQueryEditorReduceExpression>;
    type: BuilderQueryEditorExpressionType;
}
export declare const defaultBuilderQueryEditorReduceExpressionArray: Partial<BuilderQueryEditorReduceExpressionArray>;
...
export declare const defaultBuilderQueryEditorGroupByExpressionArray: Partial<BuilderQueryEditorGroupByExpressionArray>;
...
export declare const defaultBuilderQueryEditorOrderByExpressionArray: Partial<BuilderQueryEditorOrderByExpressionArray>;

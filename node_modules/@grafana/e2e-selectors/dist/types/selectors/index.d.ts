...
declare const Pages: import("..").SelectorsOf<{
    Alerting: {
        AddAlertRule: {
            url: {
                '10.1.0': string;
...
declare const Components: import("..").SelectorsOf<{
    RadioButton: {
        container: {
            '10.2.3': string;
        };
    ...
    LayoutContainer: {
        '12.4.0': (identifier: string) => string;
    };
    TimePicker: {
        moveBackwardButton: {
            '12.4.0': string;
 ...
 */
export { Pages, Components, selectors, versionedComponents, versionedPages, resolveSelectors, type VersionedPages, type VersionedComponents, type E2ESelectors, };

...
/** @internal */
export declare const GraphContextMenu: ({ getContextMenuSource, timeZone, itemsGroup, dimensions, contextDimensions, ...otherProps }: GraphContextMenuProps) => import("react/jsx-runtime").JSX.Element;
/** @internal */

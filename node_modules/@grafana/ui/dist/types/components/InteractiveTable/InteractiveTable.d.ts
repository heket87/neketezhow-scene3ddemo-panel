 ...
 * @alpha
 */
export declare function InteractiveTable<TableData extends object>({ autoResetPage, className, columns, data, getRowId, headerTooltips, pageSize, renderExpandedRow, showExpandAll, fetchData, initialSortBy, disableSortRemove, }: Props<TableData>): import("react/jsx-runtime").JSX.Element;
export {};

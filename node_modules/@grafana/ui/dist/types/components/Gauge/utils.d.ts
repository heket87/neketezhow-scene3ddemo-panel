import { FieldConfig, GrafanaTheme, GrafanaTheme2, Threshold, ThresholdsConfig } from '@grafana/data';
...
export declare function getFormattedThresholds(decimals: number, field: FieldConfig, theme: GrafanaTheme | GrafanaTheme2, offsetColor?: boolean): Threshold[];
export {};

...
export declare const getTooltipDisplayValue: (value: unknown, field: Field) => {
    text: string;
    numeric: number;
    color?: string;
};
export declare const getContentItems: (fields: Field[], xField: Field, dataIdxs: Array<number | null>, seriesIdx: number | null | undefined, mode: TooltipDisplayMode, sortOrder: SortOrder, fieldFilter?: (field: Field) => boolean, hideZeros?: boolean, _restFields?: Field[]) => VizTooltipItem[];

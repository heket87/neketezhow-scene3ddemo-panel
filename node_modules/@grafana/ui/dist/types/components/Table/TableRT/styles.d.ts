...
export declare function useTableStyles(theme: GrafanaTheme2, cellHeightOption: TableCellHeight): {
    theme: GrafanaTheme2;
    cellHeight: number;
    buildCellContainerStyle: (color?: string, background?: string, backgroundHover?: string, overflowOnHover?: boolean, asCellText?: boolean, textShouldWrap?: boolean, textWrapped?: boolean, rowStyled?: boolean, rowExpanded?: boolean) => string;
    cellPadding: number;

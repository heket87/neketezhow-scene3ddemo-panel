 ...
 */
export declare function useFixScrollbarContainer(variableSizeListScrollbarRef: React.RefObject<HTMLDivElement | null>, tableDivRef: React.RefObject<HTMLDivElement | null>): void;
/**
  ...
  height.
 */
export declare function useResetVariableListSizeCache(extendedState: GrafanaTableState, listRef: React.RefObject<VariableSizeList | null>, data: DataFrame, hasUniqueId: boolean): void;

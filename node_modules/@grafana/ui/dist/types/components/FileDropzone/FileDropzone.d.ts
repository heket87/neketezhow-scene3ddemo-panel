 ...
 */
export declare function FileDropzone({ options, children, readAs, onLoad, fileListRenderer, onFileRemove, id, }: FileDropzoneProps): import("react/jsx-runtime").JSX.Element;

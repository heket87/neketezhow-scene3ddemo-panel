    ...
    return /* @__PURE__ */ jsxs("div", { ref, className: styles.wrapper, "data-testid": selectors.components.ColorSwatch.name, ...otherProps, children: [
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          ...focusProps,
          "aria-label": colorLabel ? t("grafana-ui.color-swatch.aria-label-selected-color", "{{colorLabel}} color", { colorLabel }) : t("grafana-ui.color-swatch.aria-label-default", "Pick a color"),
          type: "button"
        }
      )
    ] });

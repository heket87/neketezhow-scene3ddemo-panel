...
const getGridStyles = (theme, enablePagination, transparent) => {
  ...
  const selectedRowColor = theme.isDark ? colorManipulator.onBackground(theme.colors.warning.main, bgColor).darken(37).toHexString() : colorManipulator.onBackground(theme.colors.warning.main, bgColor).lighten(25).toHexString();

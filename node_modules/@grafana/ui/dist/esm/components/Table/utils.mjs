...
function getColumns(data, availableWidth, columnMinWidth, expander, footerValues, isCountRowsSet) {
  ...
  for (const [fieldIndex, field] of data.fields.entries()) {
    ...
    if (
      ...
      fieldTableOptions.hidden || ((_a = fieldTableOptions.hideFrom) == null ? void 0 : _a.viz) || field.type === FieldType.nestedFrames
    ) {
      continue;
    }
    ...
    const Cell = getCellComponent((_b = fieldTableOptions.cellOptions) == null ? void 0 : _b.type, field);
    columns.push({
      // @ts-expect-error
      // TODO fix type error here
      Cell,
      ...
      minWidth: (_c = fieldTableOptions.minWidth) != null ? _c : columnMinWidth,

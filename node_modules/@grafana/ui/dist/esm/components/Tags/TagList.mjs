...
const TagListComponent = memo(
  forwardRef(
    ({ displayMax, tags, icon, onClick, className, getAriaLabel, getColorIndex }, ref) => {
      ...
      return /* @__PURE__ */ jsxs("ul", { className: cx(styles.wrapper, className), "aria-label": t("grafana-ui.tags.list-label", "Tags"), ref, children: [
        ...
        displayMax && displayMax > 0 && numTags - displayMax > 0 && /* @__PURE__ */ jsx("li", { className: styles.li, children: /* @__PURE__ */ jsxs("span", { className: styles.moreTagsLabel, children: [
          "+ ",
          numTags - displayMax
        ] }) })
      ] });

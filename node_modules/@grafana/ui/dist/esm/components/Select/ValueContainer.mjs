...
class UnthemedValueContainer extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (this.ref.current && this.props.selectProps.autoWidth && !this.props.selectProps.maxVisibleValues && !isEqual(prevProps.selectProps.value, this.props.selectProps.value)) {

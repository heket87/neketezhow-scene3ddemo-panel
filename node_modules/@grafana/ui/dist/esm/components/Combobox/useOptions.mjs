...
function useOptions(rawOptions, createCustomValue, customValueDescription) {
      ...
      if (createCustomValue && userTypedSearch) {
        ...
        if (!customValueExists) {
          ...
          currentOptions.unshift({
            ...
            description: customValueDescription != null ? customValueDescription : t("combobox.custom-value.description", "Use custom value")
          });
        }
      }

...
const TagsInput = forwardRef(
  ({
    ...
    const placeholder = placeholderProp != null ? placeholderProp : t("grafana-ui.tags-input.placeholder-new-tag", "New tag (enter key to add)");
        ...
        Input,
        {
          ...
          suffix: /* @__PURE__ */ jsx(
            Button,
            {
              ...
              title: isTagTooLong ? t("grafana-ui.tags-input.tag-too-long", "Tag too long, max 50 characters") : void 0,

...
import { calculateGridDimensions } from '../../utils/squares.mjs';
...
class VizRepeater extends PureComponent {
  ...
  renderGrid() {
    ...
    return /* @__PURE__ */ jsx("div", { style: { position: "relative", width: "100%", height: "100%" }, children: items });
  }
  render() {
    const {
      renderValue,
...
export { VizRepeater };
//# sourceMappingURL=VizRepeater.mjs.map

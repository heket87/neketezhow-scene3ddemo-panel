...
const ZoomOutTooltip = () => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: newShortcuts ? /* @__PURE__ */ jsxs(Trans, { i18nKey: "time-picker.range-picker.zoom-out-tooltip-new", children: [
    "Time range zoom out ",
    /* @__PURE__ */ jsx("br", {}),
    " t -"
  ] }) : /* @__PURE__ */ jsxs(Trans, { i18nKey: "time-picker.range-picker.zoom-out-tooltip", children: [
    "Time range zoom out ",
    /* @__PURE__ */ jsx("br", {}),
    " CTRL+Z"
  ] }) });

...
function getElementStyles(theme) {
  return react.css({
    ...
    body: {
      ...
      fontVariantNumeric: featureToggle.getFeatureToggle("tabularNumbers") ? "tabular-nums" : "initial"
    },

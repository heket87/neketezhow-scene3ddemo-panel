...
var types = require('../../components/uPlot/types.cjs');
var nullInsertThreshold = require('./nullInsertThreshold.cjs');
var nullToUndefThreshold = require('./nullToUndefThreshold.cjs');
...
function preparePlotFrame(frames, dimFields, timeRange) {
  ...
  frames = frames.map((frame) => {
    ...
    if (!((_a = xField == null ? void 0 : xField.state) == null ? void 0 : _a.nullThresholdApplied)) {
      return nullInsertThreshold.applyNullInsertThreshold({
        frame,
...
function buildScaleKey(config, fieldType) {
  ...
  const scaleUnit = (_e = config.unit) != null ? _e : types.FIXED_UNIT;

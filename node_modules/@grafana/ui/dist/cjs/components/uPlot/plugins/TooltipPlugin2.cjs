...
var CloseButton = require('./CloseButton.cjs');
    ...
    return ReactDOM.createPortal(
      /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          ref: domRef,
          children: [
            isPinned && /* @__PURE__ */ jsxRuntime.jsx(CloseButton.CloseButton, { onClick: dismiss }),
            contents
          ]
        }
      ),
...
exports.DEFAULT_TOOLTIP_WIDTH = DEFAULT_TOOLTIP_WIDTH;
exports.TOOLTIP_OFFSET = TOOLTIP_OFFSET;
exports.TooltipHoverMode = TooltipHoverMode;
exports.TooltipPlugin2 = TooltipPlugin2;
//# sourceMappingURL=TooltipPlugin2.cjs.map

...
function getOpacityGradientFn(color, opacity) {
  return (plot, seriesIdx) => {
    const ctx = measureText.getCanvasContext();
...
function scaleGradient(u, scaleKey, scaleStops, discrete = false) {
  ...
  let ctx = measureText.getCanvasContext();
...
exports.getGradientRange = getGradientRange;
exports.getHueGradientFn = getHueGradientFn;
exports.getOpacityGradientFn = getOpacityGradientFn;
exports.getScaleGradientFn = getScaleGradientFn;
exports.scaleGradient = scaleGradient;
//# sourceMappingURL=gradientFills.cjs.map

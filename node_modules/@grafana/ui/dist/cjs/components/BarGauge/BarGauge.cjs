...
function calculateTitleDimensions(props) {
  ...
  const textSize = measureText.measureText(title, titleFontSize);
...
function calculateBarAndValueDimensions(props) {
  ...
  const realTextSize = measureText.measureText(valueString, fontSizeToMeasureWith);
...
function getValueStyles(value, color, width, height, orientation, isOverflow, text) {
  ...
  if (isVertical(orientation)) {
    styles.fontSize = (_a = text == null ? void 0 : text.valueSize) != null ? _a : measureText.calculateFontSize(formattedValueString, textWidth, height, VALUE_LINE_HEIGHT);
    styles.justifyContent = `center`;
  } else {
    styles.fontSize = (_b = text == null ? void 0 : text.valueSize) != null ? _b : measureText.calculateFontSize(formattedValueString, textWidth - VALUE_LEFT_PADDING * 2, height, VALUE_LINE_HEIGHT);
...
exports.calculateBarAndValueDimensions = calculateBarAndValueDimensions;
exports.getBarGradient = getBarGradient;
exports.getBasicAndGradientStyles = getBasicAndGradientStyles;
exports.getCellColor = getCellColor;
exports.getTextValueColor = getTextValueColor;
exports.getTitleStyles = getTitleStyles;
exports.getValuePercent = getValuePercent;
//# sourceMappingURL=BarGauge.cjs.map

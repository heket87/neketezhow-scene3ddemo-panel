...
declare function renderCheckbox({
  ...
  indeterminate,
  ...props
}: RenderCheckboxProps): react_jsx_runtime2.JSX.Element;
//#endregion
//#region src/cellRenderers/renderToggleGroup.d.ts
declare function renderToggleGroup<R, SR>(props: RenderGroupCellProps<R, SR>): react_jsx_runtime2.JSX.Element;
declare function ToggleGroup<R, SR>({
  groupKey,
  isExpanded,
  tabIndex,
  toggleGroup
}: RenderGroupCellProps<R, SR>): react_jsx_runtime2.JSX.Element;
//#endregion
...
declare function textEditor<TRow, TSummaryRow>({
  ...
  onRowChange,
  onClose
}: RenderEditCellProps<TRow, TSummaryRow>): react_jsx_runtime2.JSX.Element;
//#endregion
...
declare function renderHeaderCell<R, SR>({
  ...
  sortDirection,
  priority
}: RenderHeaderCellProps<R, SR>): string | react_jsx_runtime2.JSX.Element;
//#endregion
//#region src/sortStatus.d.ts
declare function renderSortIcon({
  sortDirection
}: RenderSortIconProps): react_jsx_runtime2.JSX.Element | null;
...
//# sourceMappingURL=index-C3iEXAMh.d.ts.map